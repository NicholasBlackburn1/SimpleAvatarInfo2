...
namespace SimpleAvatarInfo.gui
{
    public static class GuiActions
    {
        ...
        public static Action CloneAvatar(string downloadlocal)
        {
            return new Action(() =>
            {
                ...
                if (menuController.activeAvatar.releaseStatus == "private")
                {
                    ...
                    VRCUiPopupManager.prop_VRCUiPopupManager_0.Method_Public_Void_String_String_String_Action_Action_1_VRCUiPopup_1("Private Avatar!", "You really can't clone a Private avatar vrchat is not made that way. Download it insted", "OwO Do it ", new Action(() =>
                    {
        ...
        {
            // Warning message for cloning a private avatar
            VRCUiPopupManager.prop_VRCUiPopupManager_0.Method_Public_Void_String_String_String_Action_Action_1_VRCUiPopup_0("Avatar Info!", avatarinfo, "Download Avatar ", new Action(() =>
            {
        ...
        public static Action openModInfoMenu()
        {
            return new Action(() =>
            {
                ...
                VRCUiPopupManager.prop_VRCUiPopupManager_0.Method_Public_Void_String_String_Single_0("Mod Info", modInfo());
